...
class CNN(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.fc = nn.Linear(config.num_filters * len(config.filter_size), 512)
        self.fc_2 = nn.Linear(512, config.num_classes)
    ...
    def forward(self, x):
        ...
        out_1, out_2, out_3, out_4 = [self.conv_and_pool(out, conv) for conv in self.convs]
