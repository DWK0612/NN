...
class DataPath:
    ...
    train_dir = 'C:\\Users\\dell\\PycharmProjects\\NN_text\\Data\\segment_data\\train'
    test_dir = 'C:\\Users\\dell\\PycharmProjects\\NN_text\\Data\\segment_data\\test'
    val_dir = 'C:\\Users\\dell\\PycharmProjects\\NN_text\\Data\\segment_data\\val'
    vocab_dir = 'C:\\Users\\dell\\PycharmProjects\\NN_text\\Ckpts\\vocab'
    target_dir = 'C:\\Users\\dell\\PycharmProjects\\NN_text\\Ckpts\\target'
    stop_words = 'C:\\Users\\dell\\PycharmProjects\\NN_text\\Ckpts\\stop_words'
...
class LoadData:
    ...
    def build_vocab(self, train_segment_dir, vocab_dir, target_dir, vocab_size=2130):
        """
        根据训练集构建词汇表并存储
        """
    ...
    def load_data(self, name='train', sequence_length=300):
        if name == 'train':
